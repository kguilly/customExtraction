...
int main(int argc, char* argv[])
{
    ...
    in = fopen("/home/kalebg/Desktop/School/Y4S1/REU/customExtraction/UtilityTools/extractTools/data/2019/20190101/hrrr.20190101.00.00.grib2", "rb");
    ...
    while ((source_handle = codes_handle_new_from_file(0, in, PRODUCT_GRIB, &err)) != NULL) {
        ...
        CODES_CHECK(codes_write_message(new_handle, "output.txt", "w"), 0);
