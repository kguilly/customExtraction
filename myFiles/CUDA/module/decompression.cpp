...
Compile:
nvcc -o run decompression.cpp decompress_cuda.cu -leccodes

 - this will generate the runfile "run"
 - ./run -h will give you help on passing parameters
*/
