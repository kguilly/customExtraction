...
station_t* cuda_orchestrate_decompress_grib(station_t*, char*, const char***, int, int);
__global__ void cuda_decompress_grib(station_t*, const char*, const char***, int,  int, int);
