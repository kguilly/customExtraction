...
__device__ void codes_check(const char* call, const char* file, int line, int e, const char* msg)
{
...
__device_ int codes_get_long(const grib_handle* h, const char* key, long* value)
{
