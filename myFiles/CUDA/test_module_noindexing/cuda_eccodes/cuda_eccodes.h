...
*/
__device__ codes_handle* codes_handle_new_from_file(codes_context* c, FILE* f, ProductKind product, int* error);
...
* @return            0 if OK, integer value on error
*/
__device__ int codes_get_long(const codes_handle* h, const char* key, long* value);
...
* @return            0 if OK, integer value on error
*/
__device__ int codes_set_double(codes_handle* h, const char* key, double val);
