...
int main() {
    ...
    st_1.values[0] = new double[num_selected_params];
    st_2.values[0] = new double[num_selected_params];
    ...
    delete [] stationArr[0].values[0];
    delete [] stationArr[1].values[0];
    delete [] stationArr;
    return 0;
}
...
void build_index_obj (station_t* stationArr) {
    ...
    err = codes_get_size(idx_h, "totalLength", &handle_size);
    if (!idx_h || err != 0) {
